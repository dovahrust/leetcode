...
impl LRUCache {
    ...
    fn new(cap: i32) -> Self {
        ...
        Self {
            ...
            table: vec![INVALID_IDX; (MAX_KEY + 1) as usize],
            head: INVALID_IDX,
            tail: INVALID_IDX,
        }
    }
    ...
    fn get(&mut self, key: i32) -> i32 {
        debug_assert!(key >= 0 && key <= MAX_KEY);

        if let node_idx = self.table[key as usize] &&  node_idx != INVALID_IDX {
    ...
    fn put(&mut self, key: i32, val: i32) {
        ...
        if let node_idx = self.table[key as usize] &&  node_idx != INVALID_IDX {
            ...
            self.table[old_tail_key as usize] = INVALID_IDX;
            self.table[key as usize] = tail_idx;
            ...
            self.table[key as usize] = new_node_idx;
        }
    }
}
